...
<?php               $total += $info['price'] * $info['amount'];
            ...
            <form action='/products/product_page' method='post'>
                <input id='cont_shop' type='submit' class='btn btn-success' value='Continue Shopping'>
            </form>
        </div>
                ...
                <div class="row setup-content" id="step-2">
                    <div class="col-xs-12">
                        <div class="col-md-6">
                            ...
                            <hr>
                            <button class="btn btn-info nextBtn btn-md pull-right" type="button" >Check Out</button>
                        </div>
                    </div>
                </div>
